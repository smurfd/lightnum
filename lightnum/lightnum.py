...
def sum(x, dtype=float16): return helper.looper_sum(x, dtype=dtype)
...
def sqrt(x, dtype=float32): return helper.looper_sqrt(x, dtype=dtype)
def arctan2(x, y, dtype=float32): return helper.looper_arctan2(x, y=y, dtype=dtype)
